<template>
      <div class="flex flex-col lg:flex-row justify-center lg:justify-between items-center w-full  mt-24 px-4 mb-10 md:py-16 lg:px-16">
            ...
            <div class="flex flex-col justify-center items-start w-11/12 mb-6 ">
              ...
              <div class="text-slate-300 flex flex-col justify-start items-start">
                  ...
                  <v-typical
                    class="blink"
                    :steps="[' Freelancer', 2000, ' Front-End developer', 2000, ' Full-Stack developer', 2000]"
                    :loop="Infinity"
                    :cursor="true"
                    :wrapper="'h2'"
                  ></v-typical>
